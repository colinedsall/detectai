...
class WebScraper:
    ...
    def save_articles(self, articles: List[Dict], source: str):
        ...
        for i, article in enumerate(articles):
            ...
            filename = f"training_data/human/{source}_{i+1}_{safe_title[:50]}.txt"
    ...
    def generate_summary_report(self, results: Dict[str, List[Dict]]):
        ...
        # Save report
        with open('training_data/scraping_report.json', 'w') as f:
        ...
        print(f"  Report saved: training_data/scraping_report.json")
...
def get_target_sites() -> List[Dict]:
    ...
    return [
        ...
        # Academic Research & Publications
        {
            ...
            'max_pages': 5,
            'description': 'MIT research and news'
        },
        {
            'name': 'sciencedaily',
        ...
        },
        {
            ...
            'max_pages': 5,
            'description': 'Academic experts writing for public'
        },
        ...
        # More News Sources
        {
            ...
            'max_pages': 5,
            'description': 'UK news and opinion'
        },
        {
            'name': 'nytimes',
        ...
        # Computer Engineering / Technical
        {
            ...
            'max_pages': 5,
            'description': 'Hardware hacking and electronics'
        },
        {
            'name': 'embedded',
        ...
        },
        {
            ...
            'max_pages': 5,
            'description': 'Politics and culture'
        },
        
        # Sports (human-written journalism)
        {
            'name': 'espn',
        ...
        # Literature and Arts
        {
            ...
            'max_pages': 5,
            'description': 'Literary criticism and essays'
        },
        {
            'name': 'paris_review',
        ...
        # Opinion and Essays
        {
            ...
            'max_pages': 5,
            'description': 'Long-form essays and reporting'
        },
        {
            'name': 'economist',
...
def main():
    ...
    print(f"\n Scraping completed!")
    print(f" Check the 'training_data/human/' directory for collected articles.")
